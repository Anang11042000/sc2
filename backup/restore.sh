...
NC='\e[0m'
###########- END COLOR CODE -##########
cekdata=$(curl -sS https://raw.githubusercontent.com/Anang11042000/backup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
clear
cd
#link izin ip vps
...
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/Anang11042000/backup/main/$nama/$nama.zip" &> /dev/null
